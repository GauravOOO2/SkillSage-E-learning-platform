...
const Tabs = () => {
  return (
    <div className=' flex flex-col sm:flex-row md:flex-row  mx-4 sm:mx-8 md:mx-12 lg:mx-16 my-8 sm:my-12'>
      
        <div className='cursor-pointer h-5 w-5 sm:h-6 sm:w-6 top-1 left-1.5'>
