...
const DropDownMenu = () => {
  ...
  <div className='w-full sm:w-3/4 lg:w-3/6 gap-4 sm:gap-8 mx-4 sm:mx-14 my-4 sm:my-8'>
    <div className='flex border border-blue-600 p-3 my-4 sm:my-6 rounded-lg justify-between'>
