...
const BodyDivision1 = () => {
  return (
    <div className=' mx-16 my-12' >
      <div>
        <p className='font-montserrat font-bold text-3xl leading-10	content-center 
        bg-gradient-to-b from-[rgba(6,40,110,1)] to-[rgba(22,78,192,1)] 
        bg-clip-text text-transparent ' >Relations and Functions ( Mathematics )</p>
      </div>
    </div>
  )
}

export default BodyDivision1